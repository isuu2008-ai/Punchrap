...
- Project zip export 기본형
- `.punchlab.json` bundle을 `.punchlab.zip`에 저장
...
7. pitch engine 개선
8. export loudness normalize
9. comp lane editing
10. project bundle zip 고도화
11. DSP 모듈 추가 분리
12. desktop wrapper
13. native audio engine
14. VST3/AU plugin

현재는 1-8번의 기본선과 timeline undo/redo, render/export queue, custom scale editor, take comping, export metadata, export preview, project zip export, waveform recording view 기본형이 들어온 상태입니다. 다음으로는 export loudness normalize, comp lane editing, project bundle zip 고도화가 중요합니다.
