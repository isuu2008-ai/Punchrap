...
7. pitch engine 개선
8. LUFS loudness analysis
9. DSP 모듈 추가 분리
10. formant-aware pitch shifting
11. desktop wrapper
12. native audio engine
13. VST3/AU plugin

현재는 1-8번의 기본선과 timeline undo/redo, render/export queue, custom scale editor, take comping, comp lane editing, export metadata, export preview, project zip export asset 포함형, waveform recording view, export peak normalize 기본형이 들어온 상태입니다. 다음으로는 LUFS loudness analysis, DSP 모듈 추가 분리, formant-aware pitch shifting이 중요합니다.
