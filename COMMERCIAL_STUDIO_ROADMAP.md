...
7. pitch engine 개선
8. project bundle zip
9. waveform recording view
10. export loudness normalize
11. DSP 모듈 추가 분리
12. desktop wrapper
13. native audio engine
14. VST3/AU plugin

현재는 1-8번의 기본선과 timeline undo/redo, render/export queue, custom scale editor, take comping, export metadata, export preview 기본형이 들어온 상태입니다. 다음으로는 project bundle zip, waveform recording view, export loudness normalize가 중요합니다.
