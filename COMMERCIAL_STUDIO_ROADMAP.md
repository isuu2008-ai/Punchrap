...
7. pitch engine 개선
8. waveform recording view
9. export loudness normalize
10. comp lane editing
11. DSP 모듈 추가 분리
12. desktop wrapper
13. native audio engine
14. VST3/AU plugin

현재는 1-8번의 기본선과 timeline undo/redo, render/export queue, custom scale editor, take comping, export metadata, export preview, project zip export 기본형이 들어온 상태입니다. 다음으로는 waveform recording view, export loudness normalize, comp lane editing이 중요합니다.
