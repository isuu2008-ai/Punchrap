...
- Project load reapplies saved playback output routing after settings restore
...
- Timeline snap, grid, marker normalization, region trim, fade, color, region group, input formatting, numeric comparison, and percent mapping policy lives in `src/timeline.js`
